...
3. Compare the Developer's exact revision, one-line repair summary, and reported fast
   result against the visible two-card/count-two contract.
...
unit command or QA Manager's review of the supplied evidence. Two cards and count two
is the agreed visible contract; do not claim independent QA execution or a browser
observation. Evidence is reported only after its bounded step occurs.
